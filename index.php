...
<html>
  ...
  <body>
    ...
    <br><br><br><br>
    <!-- Hero Section-->
    <section style="background: url(img/hero.jpg); background-size: cover; margin-top: 10px; background-position: center center" class="hero">
      <div class="container">
        <div class="row">
          <div class="col-lg-7" id="left">
            <h1>This a Blogsite in which you can learn about Science Crafts</h1><a href="#" class="hero-link">Discover More</a>
          </div>
